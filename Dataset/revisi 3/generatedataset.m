...
% %     compress image (intentional attack)
%     I = KompresiImage(I);
%     imwrite(I, 'hasilkompresi.jpg');
%     I = imread('hasilkompresi.jpg');
...
% save -v7.3 dataset_intentional dataset1 dataset2 dataset3 dataset4 dataset5
save dataset_intentional_scaling dataset1 dataset2 dataset3 dataset4 dataset5